...
<div class="span6">
    ...
    <label>Title</label>
    <br>
    <input type="text" id="title" name="row[title]" value="<?php echo $thread->title; ?>" class="span5" placeholder="">
    <label>Slug (url friendly)</label>
    <input type="text" id="slug" name="row[slug]" title="<?php echo site_url('thread/talk/'.$thread->slug); ?>" value="<?php echo $thread->slug; ?>" disabled="disabled" class="span5 disabled" placeholder="">
    <label>Category</label>
    <select class="span5" name="row[category_id]">
